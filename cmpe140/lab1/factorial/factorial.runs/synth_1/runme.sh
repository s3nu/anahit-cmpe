...
HD_PWD='C:/Users/Khalif/factorial/factorial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Factorial_fpga.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Factorial_fpga.tcl
