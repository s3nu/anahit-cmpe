...
HD_PWD='C:/Users/Khalif/factorial/factorial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Factorial_fpga.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Factorial_fpga.tcl -notrace
