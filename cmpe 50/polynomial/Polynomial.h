...
public:
	...
	friend Polynomial operator+(const float f1, const Polynomial &polyb);
	friend Polynomial operator+(const Polynomial &polya, const float f2);
	friend Polynomial operator-(const Polynomial &polya, const Polynomial &polyb);
	friend Polynomial operator-(const float f3, const Polynomial &polyb);
	friend Polynomial operator-(const Polynomial &polya, const float f4);
	friend Polynomial operator*(const Polynomial &polya, const Polynomial &polyb);
	friend Polynomial operator*(const float f5, const Polynomial &polyb);
	friend Polynomial operator*(const Polynomial &polya, const float f6);
